...
def sender():
    ...
    pub =rospy.Publisher('leapmotion/data', leapros)
    ...
    while not rospy.is_shutdown():
        ...
        #pub.publish(hand_direction=hand_direction_,
        #           hand_normal = hand_normal_,
        #          hand_palm_pos = hand_palm_pos_,
        #         hand_pitch = hand_pitch_,
        #        hand_roll = hand_roll_
        #       hand_yaw = hand_yaw_)
        pub.publish(msg)
